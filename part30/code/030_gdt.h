#ifndef UNIX_OS_030_GDT_H
#define UNIX_OS_030_GDT_H
 ...
 * (030_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (030_tss.c's tss_load()) is only valid once THIS

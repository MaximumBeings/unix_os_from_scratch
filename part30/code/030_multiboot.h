#ifndef UNIX_OS_030_MULTIBOOT_H
#define UNIX_OS_030_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 030_boot.asm
 ...
 * all -- for instance, if 030_kmain.c's own real run were ever booted

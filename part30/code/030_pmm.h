#ifndef UNIX_OS_030_PMM_H
#define UNIX_OS_030_PMM_H
 ...
 * time. A real GRUB Multiboot2 MODULE (030_multiboot.h's own
 ...
 * moment 030_elf.c's own elf_load() finally reads them. */

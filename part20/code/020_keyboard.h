#ifndef UNIX_OS_020_KEYBOARD_H
#define UNIX_OS_020_KEYBOARD_H

/* Unmasks IRQ1 on the PIC (020_pic.c) so real keyboard interrupts can
...
/* The real C handler 020_irq1.asm's stub calls on every IRQ1. Declared

#ifndef UNIX_OS_020_MULTIBOOT_H
#define UNIX_OS_020_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 020_boot.asm
 ...
 * all -- for instance, if 020_kmain.c's own real run were ever booted

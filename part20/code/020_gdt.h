#ifndef UNIX_OS_020_GDT_H
#define UNIX_OS_020_GDT_H
 ...
 * (020_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (020_tss.c's tss_load()) is only valid once THIS

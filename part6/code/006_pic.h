#ifndef UNIX_OS_006_PIC_H
#define UNIX_OS_006_PIC_H
 ...
 * vectors) and onto offset1/offset2 instead -- see 006_pic.c for why
 ...
 * is deliberately unmasked -- see 006_pic.c for why the remap step

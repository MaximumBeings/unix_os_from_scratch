#ifndef UNIX_OS_022_MULTIBOOT_H
#define UNIX_OS_022_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 022_boot.asm
 ...
 * all -- for instance, if 022_kmain.c's own real run were ever booted

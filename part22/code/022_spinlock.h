#ifndef UNIX_OS_022_SPINLOCK_H
#define UNIX_OS_022_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 022_kheap.c
 ...
 * see 022_spinlock.c for why this kernel saves and restores EFLAGS

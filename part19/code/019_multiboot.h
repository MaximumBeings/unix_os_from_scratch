#ifndef UNIX_OS_019_MULTIBOOT_H
#define UNIX_OS_019_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 019_boot.asm
 ...
 * all -- for instance, if 019_kmain.c's own real run were ever booted

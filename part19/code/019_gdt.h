#ifndef UNIX_OS_019_GDT_H
#define UNIX_OS_019_GDT_H
 ...
 * (019_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (019_tss.c's tss_load()) is only valid once THIS

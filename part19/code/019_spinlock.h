#ifndef UNIX_OS_019_SPINLOCK_H
#define UNIX_OS_019_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 019_kheap.c
 ...
 * see 019_spinlock.c for why this kernel saves and restores EFLAGS

#ifndef UNIX_OS_034_MULTIBOOT_H
#define UNIX_OS_034_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 034_boot.asm
 ...
 * all -- for instance, if 034_kmain.c's own real run were ever booted

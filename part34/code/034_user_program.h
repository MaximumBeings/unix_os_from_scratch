#ifndef UNIX_OS_034_USER_PROGRAM_H
#define UNIX_OS_034_USER_PROGRAM_H

/* The one number 034_user_program.c and 034_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 034_kmain.c itself,
 ...
 * completely separately from this kernel image (034_user_program.c's
 * own dedicated linker script, 034_user_program.ld, never even mentions
 * 034_kmain.c), so the one thing keeping this book's own real switch-

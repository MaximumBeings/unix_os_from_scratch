#ifndef UNIX_OS_034_ELF_H
#define UNIX_OS_034_ELF_H
 ...
 * `dir_phys` -- a page directory built by 034_paging.c's own
 ...
 * (034_multiboot.h's own multiboot_tag_module, GRUB's own real load).

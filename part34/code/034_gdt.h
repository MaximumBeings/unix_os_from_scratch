#ifndef UNIX_OS_034_GDT_H
#define UNIX_OS_034_GDT_H
 ...
 * (034_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (034_tss.c's tss_load()) is only valid once THIS

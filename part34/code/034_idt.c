 ...
 * 034_rtl8139.h's own top-of-file comment for the real reasoning
 * behind that exact vector number, and 034_pic.c's own real IRQ2
 ...
 * EOI time (034_pic.c's own pic_send_eoi(), unchanged since Chapter
 * 5). */
...
extern void isr0(void);     /* 034_isr0.asm -- unchanged from Chapter 4 */
extern void isr13(void);    /* 034_isr13.asm -- this chapter's own stub */
extern void isr14(void);    /* 034_isr14.asm -- unchanged from Chapter 10 */
extern void isr128(void);   /* 034_isr128.asm -- this chapter's own stub */
extern void irq0(void);     /* 034_irq0.asm -- unchanged from Chapter 6 */
extern void irq1(void);     /* 034_irq1.asm -- unchanged from Chapter 5 */
extern void irq11(void);    /* 034_irq11.asm -- this chapter's own new stub */
...
void idt_init(void) {
     ...
     * 034_rtl8139.c's own real, live PCI Interrupt Line read (offset

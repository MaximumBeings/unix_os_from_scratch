#ifndef UNIX_OS_034_PMM_H
#define UNIX_OS_034_PMM_H
 ...
 * time. A real GRUB Multiboot2 MODULE (034_multiboot.h's own
 ...
 * moment 034_elf.c's own elf_load() finally reads them. */

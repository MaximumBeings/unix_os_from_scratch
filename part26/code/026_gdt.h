#ifndef UNIX_OS_026_GDT_H
#define UNIX_OS_026_GDT_H
 ...
 * (026_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (026_tss.c's tss_load()) is only valid once THIS

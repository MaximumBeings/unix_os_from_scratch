#ifndef UNIX_OS_026_ELF_H
#define UNIX_OS_026_ELF_H
 ...
 * `dir_phys` -- a page directory built by 026_paging.c's own
 ...
 * (026_multiboot.h's own multiboot_tag_module, GRUB's own real load).

#ifndef UNIX_OS_032_SPINLOCK_H
#define UNIX_OS_032_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 032_kheap.c
 ...
 * see 032_spinlock.c for why this kernel saves and restores EFLAGS

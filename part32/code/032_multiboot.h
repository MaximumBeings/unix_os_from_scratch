#ifndef UNIX_OS_032_MULTIBOOT_H
#define UNIX_OS_032_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 032_boot.asm
 ...
 * all -- for instance, if 032_kmain.c's own real run were ever booted

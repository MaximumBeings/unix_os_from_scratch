#ifndef UNIX_OS_032_USER_PROGRAM_H
#define UNIX_OS_032_USER_PROGRAM_H

/* The one number 032_user_program.c and 032_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 032_kmain.c itself,
 ...
 * completely separately from this kernel image (032_user_program.c's
 * own dedicated linker script, 032_user_program.ld, never even mentions
 * 032_kmain.c), so the one thing keeping this book's own real switch-

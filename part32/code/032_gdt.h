#ifndef UNIX_OS_032_GDT_H
#define UNIX_OS_032_GDT_H
 ...
 * (032_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (032_tss.c's tss_load()) is only valid once THIS

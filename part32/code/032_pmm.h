#ifndef UNIX_OS_032_PMM_H
#define UNIX_OS_032_PMM_H
 ...
 * time. A real GRUB Multiboot2 MODULE (032_multiboot.h's own
 ...
 * moment 032_elf.c's own elf_load() finally reads them. */

#ifndef UNIX_OS_032_ELF_H
#define UNIX_OS_032_ELF_H
 ...
 * `dir_phys` -- a page directory built by 032_paging.c's own
 ...
 * (032_multiboot.h's own multiboot_tag_module, GRUB's own real load).

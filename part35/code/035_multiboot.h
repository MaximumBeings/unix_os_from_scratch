#ifndef UNIX_OS_035_MULTIBOOT_H
#define UNIX_OS_035_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 035_boot.asm
 ...
 * all -- for instance, if 035_kmain.c's own real run were ever booted

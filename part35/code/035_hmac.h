#ifndef UNIX_OS_035_HMAC_H
#define UNIX_OS_035_HMAC_H
 ...
 * 035_sha256.h/.c, cited separately from FIPS 180-4), B is H's real block
 ...
 * (035_aes.h/.c) for real message CONFIDENTIALITY, in the encrypt-then-MAC
 * order: encrypt first, then compute the real HMAC over the ciphertext --
 * the order this chapter's own 035_fedwire.c documents choosing (and why)
 * in its own top-of-file comment.
 */

#include <stdint.h>
#include "035_sha256.h"

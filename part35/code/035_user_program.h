#ifndef UNIX_OS_035_USER_PROGRAM_H
#define UNIX_OS_035_USER_PROGRAM_H

/* The one number 035_user_program.c and 035_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 035_kmain.c itself,
 ...
 * completely separately from this kernel image (035_user_program.c's
 * own dedicated linker script, 035_user_program.ld, never even mentions
 * 035_kmain.c), so the one thing keeping this book's own real switch-

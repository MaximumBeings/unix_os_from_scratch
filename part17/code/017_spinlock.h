#ifndef UNIX_OS_017_SPINLOCK_H
#define UNIX_OS_017_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 017_kheap.c
 ...
 * see 017_spinlock.c for why this kernel saves and restores EFLAGS

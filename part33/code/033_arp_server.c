/* See 033_arp_server.h's own top-of-file comment for the full real
...
/* Same real byte offsets 033_arp.c's own top-of-file already
...
int arp_server_handle_frame(const uint8_t *rx_frame, uint32_t rx_len,
    ...
    /* Same real fix 033_arp.c's own arp_send_request() already

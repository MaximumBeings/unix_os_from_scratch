#ifndef UNIX_OS_033_USER_PROGRAM_H
#define UNIX_OS_033_USER_PROGRAM_H

/* The one number 033_user_program.c and 033_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 033_kmain.c itself,
 ...
 * completely separately from this kernel image (033_user_program.c's
 * own dedicated linker script, 033_user_program.ld, never even mentions
 * 033_kmain.c), so the one thing keeping this book's own real switch-

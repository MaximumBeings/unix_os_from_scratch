#ifndef UNIX_OS_033_GDT_H
#define UNIX_OS_033_GDT_H
 ...
 * (033_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (033_tss.c's tss_load()) is only valid once THIS

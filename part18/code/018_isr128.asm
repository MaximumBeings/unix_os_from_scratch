...
; IDT descriptor has DPL=3 (018_idt.c), which is what lets ring-3 code
...
;
; Structurally this stub is identical to 018_isr0.asm's -- INT 0x80 is
...
; already switched ESP/SS to this TSS's own ESP0/SS0 (018_tss.c) and
...
; same way 018_isr13.asm's own IRET does for the CLI demo.
;

#ifndef UNIX_OS_016_GDT_H
#define UNIX_OS_016_GDT_H
 ...
 * (016_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (016_tss.c's tss_load()) is only valid once THIS

#ifndef UNIX_OS_015_SPINLOCK_H
#define UNIX_OS_015_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 015_kheap.c
 ...
 * see 015_spinlock.c for why this kernel saves and restores EFLAGS

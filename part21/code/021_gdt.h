#ifndef UNIX_OS_021_GDT_H
#define UNIX_OS_021_GDT_H
 ...
 * (021_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (021_tss.c's tss_load()) is only valid once THIS

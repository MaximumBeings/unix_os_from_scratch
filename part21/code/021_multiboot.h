#ifndef UNIX_OS_021_MULTIBOOT_H
#define UNIX_OS_021_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 021_boot.asm
 ...
 * all -- for instance, if 021_kmain.c's own real run were ever booted

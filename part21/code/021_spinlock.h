#ifndef UNIX_OS_021_SPINLOCK_H
#define UNIX_OS_021_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 021_kheap.c
 ...
 * see 021_spinlock.c for why this kernel saves and restores EFLAGS

#ifndef UNIX_OS_021_ELF_H
#define UNIX_OS_021_ELF_H
 ...
 * `dir_phys` -- a page directory built by 021_paging.c's own
 ...
 * (021_multiboot.h's own multiboot_tag_module, GRUB's own real load).

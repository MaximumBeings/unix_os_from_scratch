#ifndef UNIX_OS_036_PMM_H
#define UNIX_OS_036_PMM_H
 ...
 * time. A real GRUB Multiboot2 MODULE (036_multiboot.h's own
 ...
 * moment 036_elf.c's own elf_load() finally reads them. */

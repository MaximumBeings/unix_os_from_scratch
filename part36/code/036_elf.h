#ifndef UNIX_OS_036_ELF_H
#define UNIX_OS_036_ELF_H
 ...
 * `dir_phys` -- a page directory built by 036_paging.c's own
 ...
 * (036_multiboot.h's own multiboot_tag_module, GRUB's own real load).

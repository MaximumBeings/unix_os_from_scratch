#ifndef UNIX_OS_036_GDT_H
#define UNIX_OS_036_GDT_H
 ...
 * (036_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (036_tss.c's tss_load()) is only valid once THIS

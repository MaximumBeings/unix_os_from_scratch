#ifndef UNIX_OS_036_PIC_H
#define UNIX_OS_036_PIC_H
 ...
 * vectors) and onto offset1/offset2 instead -- see 036_pic.c for why
 ...
 * is deliberately unmasked -- see 036_pic.c for why the remap step

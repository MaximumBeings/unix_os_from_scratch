#ifndef UNIX_OS_029_GDT_H
#define UNIX_OS_029_GDT_H
 ...
 * (029_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (029_tss.c's tss_load()) is only valid once THIS

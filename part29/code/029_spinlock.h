#ifndef UNIX_OS_029_SPINLOCK_H
#define UNIX_OS_029_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 029_kheap.c
 ...
 * see 029_spinlock.c for why this kernel saves and restores EFLAGS

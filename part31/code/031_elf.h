#ifndef UNIX_OS_031_ELF_H
#define UNIX_OS_031_ELF_H
 ...
 * `dir_phys` -- a page directory built by 031_paging.c's own
 ...
 * (031_multiboot.h's own multiboot_tag_module, GRUB's own real load).

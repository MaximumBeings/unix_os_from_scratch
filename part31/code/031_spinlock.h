#ifndef UNIX_OS_031_SPINLOCK_H
#define UNIX_OS_031_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 031_kheap.c
 ...
 * see 031_spinlock.c for why this kernel saves and restores EFLAGS

#ifndef UNIX_OS_031_USER_PROGRAM_H
#define UNIX_OS_031_USER_PROGRAM_H

/* The one number 031_user_program.c and 031_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 031_kmain.c itself,
 ...
 * completely separately from this kernel image (031_user_program.c's
 * own dedicated linker script, 031_user_program.ld, never even mentions
 * 031_kmain.c), so the one thing keeping this book's own real switch-

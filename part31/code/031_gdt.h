#ifndef UNIX_OS_031_GDT_H
#define UNIX_OS_031_GDT_H
 ...
 * (031_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (031_tss.c's tss_load()) is only valid once THIS

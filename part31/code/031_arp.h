#ifndef UNIX_OS_031_ARP_H
#define UNIX_OS_031_ARP_H

#include <stdint.h>

/* Chapter 28's own new, minimal ARP client, built entirely on top of
 * 031_rtl8139.c's own real rtl8139_send()/rtl8139_receive_next_packet()
 ...
 * own new, real, non-loopback mode (see 031_rtl8139.c's own
 ...
 * little-endian, exactly the same real reason 031_kmain.c's own
 ...
 * has cited since Chapter 25 (see 031_kmain.c's own DEMO_FRAME_SIZE
 * comment). */
 ...
 * 031_rtl8139.c's own rtl8139_send_queue() (real round-robin
 ...
 * can leave that second real send genuinely stuck (031_rtl8139.c's
...
/* Blocks (via 031_rtl8139.c's own real, interrupt-driven

#ifndef UNIX_OS_028_MULTIBOOT_H
#define UNIX_OS_028_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 028_boot.asm
 ...
 * all -- for instance, if 028_kmain.c's own real run were ever booted

#ifndef UNIX_OS_028_USER_PROGRAM_H
#define UNIX_OS_028_USER_PROGRAM_H

/* The one number 028_user_program.c and 028_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 028_kmain.c itself,
 ...
 * completely separately from this kernel image (028_user_program.c's
 * own dedicated linker script, 028_user_program.ld, never even mentions
 * 028_kmain.c), so the one thing keeping this book's own real switch-

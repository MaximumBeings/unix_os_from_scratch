#ifndef UNIX_OS_024_ELF_H
#define UNIX_OS_024_ELF_H
 ...
 * `dir_phys` -- a page directory built by 024_paging.c's own
 ...
 * (024_multiboot.h's own multiboot_tag_module, GRUB's own real load).

#ifndef UNIX_OS_024_GDT_H
#define UNIX_OS_024_GDT_H
 ...
 * (024_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (024_tss.c's tss_load()) is only valid once THIS

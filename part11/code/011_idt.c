...
extern void isr0(void);    /* 011_isr0.asm -- unchanged from Chapter 4 */
extern void isr14(void);   /* 011_isr14.asm -- this chapter's own stub */
extern void irq0(void);    /* 011_irq0.asm -- unchanged from Chapter 6 */
extern void irq1(void);    /* 011_irq1.asm -- unchanged from Chapter 5 */
...
void idt_init(void) {
     ...
     * 011_isr14.asm's own stub has to know that. */

...
extern void isr0(void);   /* 007_isr0.asm -- unchanged from Chapter 4 */
extern void irq0(void);   /* 007_irq0.asm -- this chapter's own stub */
extern void irq1(void);   /* 007_irq1.asm -- unchanged from Chapter 5 */
...
void idt_init(void) {
    ...
    /* Vector 0x20: IRQ0, the PIT timer, after 007_pic.c's own PIC_remap

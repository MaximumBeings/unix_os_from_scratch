#ifndef UNIX_OS_031_MULTIBOOT_H
#define UNIX_OS_031_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 031_boot.asm
 ...
 * all -- for instance, if 031_kmain.c's own real run were ever booted

#ifndef UNIX_OS_016_SPINLOCK_H
#define UNIX_OS_016_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 016_kheap.c
 ...
 * see 016_spinlock.c for why this kernel saves and restores EFLAGS

#ifndef UNIX_OS_025_SPINLOCK_H
#define UNIX_OS_025_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 025_kheap.c
 ...
 * see 025_spinlock.c for why this kernel saves and restores EFLAGS

#ifndef UNIX_OS_025_GDT_H
#define UNIX_OS_025_GDT_H
 ...
 * (025_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (025_tss.c's tss_load()) is only valid once THIS

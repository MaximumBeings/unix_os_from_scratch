#ifndef UNIX_OS_025_USER_PROGRAM_H
#define UNIX_OS_025_USER_PROGRAM_H

/* The one number 025_user_program.c and 025_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 025_kmain.c itself,
 ...
 * completely separately from this kernel image (025_user_program.c's
 * own dedicated linker script, 025_user_program.ld, never even mentions
 * 025_kmain.c), so the one thing keeping this book's own real switch-

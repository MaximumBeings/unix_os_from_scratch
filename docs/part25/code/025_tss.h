#ifndef UNIX_OS_025_TSS_H
#define UNIX_OS_025_TSS_H
 ...
 * (025_switch.asm, unchanged since Chapter 11). This ONE TSS exists
 ...
 * 025_tss.c for the real mechanics. */
 ...
 * 025_gdt.c to build its GDT descriptor, so the TSS's own struct
 * layout stays private to 025_tss.c. */

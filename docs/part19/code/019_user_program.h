#ifndef UNIX_OS_019_USER_PROGRAM_H
#define UNIX_OS_019_USER_PROGRAM_H

/* The one number 019_user_program.c and 019_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 019_kmain.c itself,
 ...
 * completely separately from this kernel image (019_user_program.c's
 * own dedicated linker script, 019_user_program.ld, never even mentions
 * 019_kmain.c), so the one thing keeping this book's own real switch-

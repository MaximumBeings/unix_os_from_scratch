#ifndef UNIX_OS_017_TSS_H
#define UNIX_OS_017_TSS_H
 ...
 * (017_switch.asm, unchanged since Chapter 11). This ONE TSS exists
 ...
 * 017_tss.c for the real mechanics. */
 ...
 * 017_gdt.c to build its GDT descriptor, so the TSS's own struct
 * layout stays private to 017_tss.c. */

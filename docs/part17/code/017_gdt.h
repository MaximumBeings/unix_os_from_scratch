#ifndef UNIX_OS_017_GDT_H
#define UNIX_OS_017_GDT_H
 ...
 * (017_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (017_tss.c's tss_load()) is only valid once THIS

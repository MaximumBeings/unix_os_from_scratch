#ifndef UNIX_OS_030_TSS_H
#define UNIX_OS_030_TSS_H
 ...
 * (030_switch.asm, unchanged since Chapter 11). This ONE TSS exists
 ...
 * 030_tss.c for the real mechanics. */
 ...
 * 030_gdt.c to build its GDT descriptor, so the TSS's own struct
 * layout stays private to 030_tss.c. */

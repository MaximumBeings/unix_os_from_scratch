#ifndef UNIX_OS_030_SPINLOCK_H
#define UNIX_OS_030_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 030_kheap.c
 ...
 * see 030_spinlock.c for why this kernel saves and restores EFLAGS

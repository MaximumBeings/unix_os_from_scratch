#ifndef UNIX_OS_030_KEYBOARD_H
#define UNIX_OS_030_KEYBOARD_H

/* Unmasks IRQ1 on the PIC (030_pic.c) so real keyboard interrupts can
...
/* The real C handler 030_irq1.asm's stub calls on every IRQ1. Declared

#ifndef UNIX_OS_030_USER_PROGRAM_H
#define UNIX_OS_030_USER_PROGRAM_H

/* The one number 030_user_program.c and 030_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 030_kmain.c itself,
 ...
 * completely separately from this kernel image (030_user_program.c's
 * own dedicated linker script, 030_user_program.ld, never even mentions
 * 030_kmain.c), so the one thing keeping this book's own real switch-

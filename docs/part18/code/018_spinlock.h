#ifndef UNIX_OS_018_SPINLOCK_H
#define UNIX_OS_018_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 018_kheap.c
 ...
 * see 018_spinlock.c for why this kernel saves and restores EFLAGS

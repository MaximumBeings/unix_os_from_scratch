#ifndef UNIX_OS_018_GDT_H
#define UNIX_OS_018_GDT_H
 ...
 * (018_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (018_tss.c's tss_load()) is only valid once THIS

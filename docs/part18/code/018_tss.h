#ifndef UNIX_OS_018_TSS_H
#define UNIX_OS_018_TSS_H
 ...
 * (018_switch.asm, unchanged since Chapter 11). This ONE TSS exists
 ...
 * 018_tss.c for the real mechanics. */
 ...
 * 018_gdt.c to build its GDT descriptor, so the TSS's own struct
 * layout stays private to 018_tss.c. */

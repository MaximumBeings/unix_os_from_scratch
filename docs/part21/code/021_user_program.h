#ifndef UNIX_OS_021_USER_PROGRAM_H
#define UNIX_OS_021_USER_PROGRAM_H

/* The one number 021_user_program.c and 021_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 021_kmain.c itself,
 ...
 * completely separately from this kernel image (021_user_program.c's
 * own dedicated linker script, 021_user_program.ld, never even mentions
 * 021_kmain.c), so the one thing keeping this book's own real switch-

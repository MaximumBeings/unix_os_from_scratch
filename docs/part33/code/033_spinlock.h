#ifndef UNIX_OS_033_SPINLOCK_H
#define UNIX_OS_033_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 033_kheap.c
 ...
 * see 033_spinlock.c for why this kernel saves and restores EFLAGS

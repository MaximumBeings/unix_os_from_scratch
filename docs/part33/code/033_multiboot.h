#ifndef UNIX_OS_033_MULTIBOOT_H
#define UNIX_OS_033_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 033_boot.asm
 ...
 * all -- for instance, if 033_kmain.c's own real run were ever booted

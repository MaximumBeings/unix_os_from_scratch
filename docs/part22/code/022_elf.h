#ifndef UNIX_OS_022_ELF_H
#define UNIX_OS_022_ELF_H
 ...
 * `dir_phys` -- a page directory built by 022_paging.c's own
 ...
 * (022_multiboot.h's own multiboot_tag_module, GRUB's own real load).

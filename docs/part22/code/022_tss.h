#ifndef UNIX_OS_022_TSS_H
#define UNIX_OS_022_TSS_H
 ...
 * (022_switch.asm, unchanged since Chapter 11). This ONE TSS exists
 ...
 * 022_tss.c for the real mechanics. */
 ...
 * 022_gdt.c to build its GDT descriptor, so the TSS's own struct
 * layout stays private to 022_tss.c. */

#ifndef UNIX_OS_022_GDT_H
#define UNIX_OS_022_GDT_H
 ...
 * (022_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (022_tss.c's tss_load()) is only valid once THIS

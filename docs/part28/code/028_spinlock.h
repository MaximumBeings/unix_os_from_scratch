#ifndef UNIX_OS_028_SPINLOCK_H
#define UNIX_OS_028_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 028_kheap.c
 ...
 * see 028_spinlock.c for why this kernel saves and restores EFLAGS

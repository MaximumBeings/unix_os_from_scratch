#ifndef UNIX_OS_029_USER_PROGRAM_H
#define UNIX_OS_029_USER_PROGRAM_H

/* The one number 029_user_program.c and 029_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 029_kmain.c itself,
 ...
 * completely separately from this kernel image (029_user_program.c's
 * own dedicated linker script, 029_user_program.ld, never even mentions
 * 029_kmain.c), so the one thing keeping this book's own real switch-

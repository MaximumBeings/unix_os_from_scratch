#ifndef UNIX_OS_029_MULTIBOOT_H
#define UNIX_OS_029_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 029_boot.asm
 ...
 * all -- for instance, if 029_kmain.c's own real run were ever booted

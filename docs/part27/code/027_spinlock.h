#ifndef UNIX_OS_027_SPINLOCK_H
#define UNIX_OS_027_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 027_kheap.c
 ...
 * see 027_spinlock.c for why this kernel saves and restores EFLAGS

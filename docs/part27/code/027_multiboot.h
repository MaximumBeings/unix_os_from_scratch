#ifndef UNIX_OS_027_MULTIBOOT_H
#define UNIX_OS_027_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 027_boot.asm
 ...
 * all -- for instance, if 027_kmain.c's own real run were ever booted

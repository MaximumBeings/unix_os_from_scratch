#ifndef UNIX_OS_027_ELF_H
#define UNIX_OS_027_ELF_H
 ...
 * `dir_phys` -- a page directory built by 027_paging.c's own
 ...
 * (027_multiboot.h's own multiboot_tag_module, GRUB's own real load).

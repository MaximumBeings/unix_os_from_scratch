#ifndef UNIX_OS_027_USER_PROGRAM_H
#define UNIX_OS_027_USER_PROGRAM_H

/* The one number 027_user_program.c and 027_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 027_kmain.c itself,
 ...
 * completely separately from this kernel image (027_user_program.c's
 * own dedicated linker script, 027_user_program.ld, never even mentions
 * 027_kmain.c), so the one thing keeping this book's own real switch-

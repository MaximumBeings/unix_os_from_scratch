#ifndef UNIX_OS_027_GDT_H
#define UNIX_OS_027_GDT_H
 ...
 * (027_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (027_tss.c's tss_load()) is only valid once THIS

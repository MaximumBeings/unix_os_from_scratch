#ifndef UNIX_OS_027_PMM_H
#define UNIX_OS_027_PMM_H
 ...
 * time. A real GRUB Multiboot2 MODULE (027_multiboot.h's own
 ...
 * moment 027_elf.c's own elf_load() finally reads them. */

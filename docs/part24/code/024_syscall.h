#ifndef UNIX_OS_024_SYSCALL_H
#define UNIX_OS_024_SYSCALL_H

/* This chapter's whole syscall table: three real numbers, unchanged
 * since Chapter 16, shared between every ring-3 caller (024_kmain.c's
 ...
 * (024_isr_handlers.c's isr128_handler(), which switches on it).
 ...
 * back into ring 0 was missing, and INT 0x80 (024_isr128.asm) was

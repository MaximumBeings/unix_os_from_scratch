#ifndef UNIX_OS_024_PIC_H
#define UNIX_OS_024_PIC_H
 ...
 * vectors) and onto offset1/offset2 instead -- see 024_pic.c for why
 ...
 * is deliberately unmasked -- see 024_pic.c for why the remap step

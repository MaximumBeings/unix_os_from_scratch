#ifndef UNIX_OS_024_SPINLOCK_H
#define UNIX_OS_024_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 024_kheap.c
 ...
 * see 024_spinlock.c for why this kernel saves and restores EFLAGS

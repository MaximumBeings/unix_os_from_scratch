#ifndef UNIX_OS_024_USER_PROGRAM_H
#define UNIX_OS_024_USER_PROGRAM_H

/* The one number 024_user_program.c and 024_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 024_kmain.c itself,
 ...
 * completely separately from this kernel image (024_user_program.c's
 * own dedicated linker script, 024_user_program.ld, never even mentions
 * 024_kmain.c), so the one thing keeping this book's own real switch-

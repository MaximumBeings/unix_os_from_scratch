#ifndef UNIX_OS_024_PMM_H
#define UNIX_OS_024_PMM_H
 ...
 * time. A real GRUB Multiboot2 MODULE (024_multiboot.h's own
 ...
 * moment 024_elf.c's own elf_load() finally reads them. */

#ifndef UNIX_OS_026_USER_PROGRAM_H
#define UNIX_OS_026_USER_PROGRAM_H

/* The one number 026_user_program.c and 026_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 026_kmain.c itself,
 ...
 * completely separately from this kernel image (026_user_program.c's
 * own dedicated linker script, 026_user_program.ld, never even mentions
 * 026_kmain.c), so the one thing keeping this book's own real switch-

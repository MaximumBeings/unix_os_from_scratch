#ifndef UNIX_OS_026_PMM_H
#define UNIX_OS_026_PMM_H
 ...
 * time. A real GRUB Multiboot2 MODULE (026_multiboot.h's own
 ...
 * moment 026_elf.c's own elf_load() finally reads them. */

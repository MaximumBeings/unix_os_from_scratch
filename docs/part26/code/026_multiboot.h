#ifndef UNIX_OS_026_MULTIBOOT_H
#define UNIX_OS_026_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 026_boot.asm
 ...
 * all -- for instance, if 026_kmain.c's own real run were ever booted

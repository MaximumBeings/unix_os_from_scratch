#ifndef UNIX_OS_026_TSS_H
#define UNIX_OS_026_TSS_H
 ...
 * (026_switch.asm, unchanged since Chapter 11). This ONE TSS exists
 ...
 * 026_tss.c for the real mechanics. */
 ...
 * 026_gdt.c to build its GDT descriptor, so the TSS's own struct
 * layout stays private to 026_tss.c. */

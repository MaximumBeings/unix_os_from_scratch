 ...
 * (https://wiki.osdev.org/PCI) -- see 026_pci.h's own top-of-file
 ...
 * new 026_rtl8139.h/.c must WRITE the PCI Command register before the
 ...
 * layout cited in 026_pci.h: bit 31 is the Enable bit (always set
 ...
 * cited directly in 026_pci.h's own top-of-file comment -- builds the
 ...
 * CONFIG_DATA instead of reading it. Used by 026_rtl8139.c to enable
 ...
 * 026_pci.h. Every other field decoded below follows the same real,
 ...
 * the Multi-Function bit -- cited directly in 026_pci.h: "If it's not
 ...
 * 026_pci.h. This driver never assumes which buses actually exist the

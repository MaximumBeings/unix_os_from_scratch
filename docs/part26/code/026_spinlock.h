#ifndef UNIX_OS_026_SPINLOCK_H
#define UNIX_OS_026_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 026_kheap.c
 ...
 * see 026_spinlock.c for why this kernel saves and restores EFLAGS

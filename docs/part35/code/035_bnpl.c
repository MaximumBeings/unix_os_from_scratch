/* See 035_bnpl.h's own top-of-file comment for the full citation trail
 ...
 * undefined __udivdi3 -- the same real failure 035_pmm.c (Chapter 7)
 * and 035_fedwire.c (Chapter 30) each document. The remainder stays
 ...
 * comfortably inside a uint64_t (see BNPL_MAX_CENTS in 035_bnpl.h). */
...
int bnpl_build_pay_in_4(uint32_t cash_price_cents, uint32_t fee_cents,
    ...
    /* This book's own rounding convention (see 035_bnpl.h): equal

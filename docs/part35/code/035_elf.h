#ifndef UNIX_OS_035_ELF_H
#define UNIX_OS_035_ELF_H
 ...
 * `dir_phys` -- a page directory built by 035_paging.c's own
 ...
 * (035_multiboot.h's own multiboot_tag_module, GRUB's own real load).

#ifndef UNIX_OS_034_HMAC_H
#define UNIX_OS_034_HMAC_H
 ...
 * 034_sha256.h/.c, cited separately from FIPS 180-4), B is H's real block
 ...
 * (034_aes.h/.c) for real message CONFIDENTIALITY, in the encrypt-then-MAC
 * order: encrypt first, then compute the real HMAC over the ciphertext --
 * the order this chapter's own 034_fedwire.c documents choosing (and why)
 * in its own top-of-file comment.
 */

#include <stdint.h>
#include "034_sha256.h"

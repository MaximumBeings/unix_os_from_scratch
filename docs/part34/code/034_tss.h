#ifndef UNIX_OS_034_TSS_H
#define UNIX_OS_034_TSS_H
 ...
 * (034_switch.asm, unchanged since Chapter 11). This ONE TSS exists
 ...
 * 034_tss.c for the real mechanics. */
 ...
 * 034_gdt.c to build its GDT descriptor, so the TSS's own struct
 * layout stays private to 034_tss.c. */

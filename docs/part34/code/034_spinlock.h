#ifndef UNIX_OS_034_SPINLOCK_H
#define UNIX_OS_034_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 034_kheap.c
 ...
 * see 034_spinlock.c for why this kernel saves and restores EFLAGS

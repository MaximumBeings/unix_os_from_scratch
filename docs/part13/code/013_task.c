...
/* Chapter 12 needed 3 slots (kmain's own task 0, plus its two demo
 * tasks). This chapter adds two more demo tasks of its own (the
 * kheap stress test, below) without reclaiming Chapter 12's -- this
 * scheduler still never reuses a finished task's slot -- so the

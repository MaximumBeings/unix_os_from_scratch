#ifndef UNIX_OS_020_USER_PROGRAM_H
#define UNIX_OS_020_USER_PROGRAM_H

/* The one number 020_user_program.c and 020_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 020_kmain.c itself,
 ...
 * completely separately from this kernel image (020_user_program.c's
 * own dedicated linker script, 020_user_program.ld, never even mentions
 * 020_kmain.c), so the one thing keeping this book's own real switch-

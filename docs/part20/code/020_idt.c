...
extern void isr0(void);     /* 020_isr0.asm -- unchanged from Chapter 4 */
extern void isr13(void);    /* 020_isr13.asm -- this chapter's own stub */
extern void isr14(void);    /* 020_isr14.asm -- unchanged from Chapter 10 */
extern void isr128(void);   /* 020_isr128.asm -- this chapter's own stub */
extern void irq0(void);     /* 020_irq0.asm -- unchanged from Chapter 6 */
extern void irq1(void);     /* 020_irq1.asm -- unchanged from Chapter 5 */

#ifndef UNIX_OS_020_SPINLOCK_H
#define UNIX_OS_020_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 020_kheap.c
 ...
 * see 020_spinlock.c for why this kernel saves and restores EFLAGS

#ifndef UNIX_OS_037_SPINLOCK_H
#define UNIX_OS_037_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 037_kheap.c
 ...
 * see 037_spinlock.c for why this kernel saves and restores EFLAGS

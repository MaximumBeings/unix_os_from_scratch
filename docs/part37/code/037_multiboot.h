#ifndef UNIX_OS_037_MULTIBOOT_H
#define UNIX_OS_037_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 037_boot.asm
 ...
 * all -- for instance, if 037_kmain.c's own real run were ever booted

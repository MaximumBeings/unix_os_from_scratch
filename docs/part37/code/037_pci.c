 ...
 * (https://wiki.osdev.org/PCI) -- see 037_pci.h's own top-of-file
 ...
 * new 037_rtl8139.h/.c must WRITE the PCI Command register before the
 ...
 * layout cited in 037_pci.h: bit 31 is the Enable bit (always set
 ...
 * cited directly in 037_pci.h's own top-of-file comment -- builds the
 ...
 * CONFIG_DATA instead of reading it. Used by 037_rtl8139.c to enable
 ...
 * 037_pci.h. Every other field decoded below follows the same real,
 ...
 * the Multi-Function bit -- cited directly in 037_pci.h: "If it's not
 ...
 * 037_pci.h. This driver never assumes which buses actually exist the

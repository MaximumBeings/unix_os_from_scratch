#ifndef UNIX_OS_037_GDT_H
#define UNIX_OS_037_GDT_H
 ...
 * (037_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (037_tss.c's tss_load()) is only valid once THIS

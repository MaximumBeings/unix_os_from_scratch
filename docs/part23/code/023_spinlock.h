#ifndef UNIX_OS_023_SPINLOCK_H
#define UNIX_OS_023_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 023_kheap.c
 ...
 * see 023_spinlock.c for why this kernel saves and restores EFLAGS

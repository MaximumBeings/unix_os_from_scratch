#ifndef UNIX_OS_023_USER_PROGRAM_H
#define UNIX_OS_023_USER_PROGRAM_H

/* The one number 023_user_program.c and 023_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 023_kmain.c itself,
 ...
 * completely separately from this kernel image (023_user_program.c's
 * own dedicated linker script, 023_user_program.ld, never even mentions
 * 023_kmain.c), so the one thing keeping this book's own real switch-

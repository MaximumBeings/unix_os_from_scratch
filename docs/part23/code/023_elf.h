#ifndef UNIX_OS_023_ELF_H
#define UNIX_OS_023_ELF_H
 ...
 * `dir_phys` -- a page directory built by 023_paging.c's own
 ...
 * (023_multiboot.h's own multiboot_tag_module, GRUB's own real load).

#ifndef UNIX_OS_023_MULTIBOOT_H
#define UNIX_OS_023_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 023_boot.asm
 ...
 * all -- for instance, if 023_kmain.c's own real run were ever booted

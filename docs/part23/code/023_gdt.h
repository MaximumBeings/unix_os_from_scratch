#ifndef UNIX_OS_023_GDT_H
#define UNIX_OS_023_GDT_H
 ...
 * (023_tss.c) -- the GDT and the TSS are installed together here
 ...
 * at it, and LTR (023_tss.c's tss_load()) is only valid once THIS

/* See 036_arp.h's own top-of-file comment for the full real citation
 ...
 * cited field-for-field in 036_arp.h: a real 14-byte Ethernet header
...
int arp_send_request(const uint8_t *src_mac, const uint8_t src_ip[4],
     ...
     * 036_rtl8139.c's own rtl8139_send() comment) -- Chapter 28 never

#ifndef UNIX_OS_036_SPINLOCK_H
#define UNIX_OS_036_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 036_kheap.c
 ...
 * see 036_spinlock.c for why this kernel saves and restores EFLAGS

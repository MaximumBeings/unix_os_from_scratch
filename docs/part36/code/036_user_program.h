#ifndef UNIX_OS_036_USER_PROGRAM_H
#define UNIX_OS_036_USER_PROGRAM_H

/* The one number 036_user_program.c and 036_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 036_kmain.c itself,
 ...
 * completely separately from this kernel image (036_user_program.c's
 * own dedicated linker script, 036_user_program.ld, never even mentions
 * 036_kmain.c), so the one thing keeping this book's own real switch-

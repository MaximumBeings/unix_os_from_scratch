#ifndef UNIX_OS_025_PMM_H
#define UNIX_OS_025_PMM_H
 ...
 * time. A real GRUB Multiboot2 MODULE (025_multiboot.h's own
 ...
 * moment 025_elf.c's own elf_load() finally reads them. */

#ifndef UNIX_OS_025_ELF_H
#define UNIX_OS_025_ELF_H
 ...
 * `dir_phys` -- a page directory built by 025_paging.c's own
 ...
 * (025_multiboot.h's own multiboot_tag_module, GRUB's own real load).

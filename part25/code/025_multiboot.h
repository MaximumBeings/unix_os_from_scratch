#ifndef UNIX_OS_025_MULTIBOOT_H
#define UNIX_OS_025_MULTIBOOT_H
 ...
 * mboot_info_addr (the physical address this book's own 025_boot.asm
 ...
 * all -- for instance, if 025_kmain.c's own real run were ever booted

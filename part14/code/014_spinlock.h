#ifndef UNIX_OS_014_SPINLOCK_H
#define UNIX_OS_014_SPINLOCK_H
 ...
 * kmalloc()/kfree() were never written to survive -- see 014_kheap.c
 ...
 * see 014_spinlock.c for why this kernel saves and restores EFLAGS

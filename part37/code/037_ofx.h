#ifndef UNIX_OS_037_OFX_H
#define UNIX_OS_037_OFX_H
 ...
 * `<FITID>...`, and `<NAME>...` inside it never do. `037_ofx.c`'s own
 ...
 * parsed OFX feed (see 037_budget.h) are this book's own, not part of

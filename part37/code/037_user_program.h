#ifndef UNIX_OS_037_USER_PROGRAM_H
#define UNIX_OS_037_USER_PROGRAM_H

/* The one number 037_user_program.c and 037_kmain.c both need to agree
 ...
 * ITERATIONS) could simply live as a #define inside 037_kmain.c itself,
 ...
 * completely separately from this kernel image (037_user_program.c's
 * own dedicated linker script, 037_user_program.ld, never even mentions
 * 037_kmain.c), so the one thing keeping this book's own real switch-

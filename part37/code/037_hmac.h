#ifndef UNIX_OS_037_HMAC_H
#define UNIX_OS_037_HMAC_H
 ...
 * 037_sha256.h/.c, cited separately from FIPS 180-4), B is H's real block
 ...
 * (037_aes.h/.c) for real message CONFIDENTIALITY, in the encrypt-then-MAC
 * order: encrypt first, then compute the real HMAC over the ciphertext --
 * the order this chapter's own 037_fedwire.c documents choosing (and why)
